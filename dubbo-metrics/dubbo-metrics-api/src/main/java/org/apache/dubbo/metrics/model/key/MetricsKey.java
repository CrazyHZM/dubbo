...
public enum MetricsKey {
    ...
    METRIC_REQUESTS_SERVICE_UNAVAILABLE_FAILED(
            "requests.failed.service.unavailable.total", "Total Service Unavailable Failed Requests"),
    ...
    METRIC_REQUESTS_NETWORK_FAILED_AGG(
            "requests.failed.network.total.aggregate", "Aggregated failed network total Requests"),
    ...
    METRIC_REQUESTS_TOTAL_SERVICE_UNAVAILABLE_FAILED_AGG(
            "requests.failed.service.unavailable.total.aggregate", "Aggregated failed codec total Requests"),
    ...
    INVOKER_NO_AVAILABLE_COUNT(
            "consumer.invoker.no.available.count", "Request Throw No Invoker Available Exception Count"),
