...
public interface DubboBeanUtils {
    ...
    static void registerCommonBeans(BeanDefinitionRegistry registry) {
        ...
        registerInfrastructureBean(registry, Spring6Utils.referenceAnnotationBeanPostProcessor().getName(),
            Spring6Utils.referenceAnnotationBeanPostProcessor());
        ...
        registerInfrastructureBean(registry, DubboInfraBeanRegisterPostProcessor.BEAN_NAME, Spring6Utils.dubboInfraBeanRegisterPostProcessor());
    }
